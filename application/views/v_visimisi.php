...
<div class="col-lg-12" style="background-color: white; margin-top: 25px; box-shadow: 1px 1px 1px;">
    ...
    <div class="col-lg-8" style="margin-bottom: 65px; padding-left: 5%; padding-top: 25px; ">
        ...
        <h3 style="padding-bottom: 10px; padding-top: 20px">Visi</h3>
        <p>
            Mewujudkan BMKG yang handal, tanggap dan mampu dalam rangka mendukung keselamatan masyarakat serta keberhasilan pembangunan nasional, dan berperan aktif di tingkat Internasional. Terminologi di dalam visi tersebut dapat dijelaskan sebagai berikut :</p>
        <ol type="a">
    ...
    <div class="col-lg-4" style="padding-top: 25px; padding-bottom: 100px;">
