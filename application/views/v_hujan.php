...
<div class="container">
    <div class="col-lg-12" style="margin-bottom: 65px; margin-top: 3%">
        <ul class="nav nav-tabs" style="margin-top:25px; margin-bottom: 3%">
            <li class="active">
                <a data-toggle="tab" href="#perbandingan" style="font-size: 12px; font-weight: bold">Perbandingan</a>
            </li>
            <li>
                <a data-toggle="tab" href="#bulan" style="font-size: 12px; font-weight: bold">Data Bulan Ini</a>
            </li>
        </ul>
        <div class="tab-content">
            <div id="perbandingan" class="tab-pane fade in active">
                <div class="col-lg-12">
                    <div class="col-lg-3" >
                        <form role="form">
                    ...
                    <div id="grafik2" style="margin-top: 5%; margin-bottom: 5%"></div>
                </div>
            </div>
            <div id="bulan" class="tab-pane fade in active">
                <div class="col-lg-12">
                    ...
                    <div id="grafik4" style="margin-top: 5%; margin-bottom: 5%"></div>
                </div>
            </div>
